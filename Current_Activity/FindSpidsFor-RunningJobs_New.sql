/* This script can be used to find the spids (session_ids) for various SqlAgent jobs. Script was obtained by slightly modifying the script 
available here:
http://jasonbrimhall.info/2016/12/23/what-agent-job-is-running-back-to-basics/
*/
